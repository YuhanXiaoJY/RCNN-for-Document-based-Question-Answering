...
class BiLSTM(object):
    def __init__(self, batch_size, max_sentence_len, embeddings, rnn_size, margin):
        ...
        with tf.device("/cpu:0"), tf.name_scope("embedding_layer"):
            ...
            querys = tf.nn.embedding_lookup(tf_embedding, self.inputQuestions)
            ...
            test_querys = tf.nn.embedding_lookup(tf_embedding, self.inputTestQuestions)
